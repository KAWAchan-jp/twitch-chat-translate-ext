...
- **Индикаторы движков перевода в футере** — внизу панели в реальном времени показываются движок перевода ваших сообщений, движок перевода голосовых субтитров и движок STT.
...
- **Фильтрация галлюцинаций** — Обнаруживает и отбрасывает зацикленные повторы фраз Whisper перед записью в субтитры.
...
| Число вроде 0.5.7.0 | Версия расширения |
...
| **STT:** | Движок распознавания речи (Local = локальный Whisper / <span style="color:#f0971d">Groq</span> = Groq Whisper API) |
