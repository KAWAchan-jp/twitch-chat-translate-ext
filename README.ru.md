...
- **Индикаторы движков перевода в футере** — внизу панели всегда показываются движки перевода для ваших сообщений и голосовых субтитров (Google / DeepL / Gemini).
...
- **Gemini 2.0 Flash** — использует Gemini AI для перевода голосовых субтитров и отправляемых сообщений, давая естественный перевод игровых терминов и сленга.
...
| Отображение | Описание |
|-------------|----------|
| **Chat:** | Движок перевода для сообщений, которые вы вводите и отправляете (Google / <span style="color:#00c4a0">DeepL</span>) |
...
Изменения на странице настроек сразу отражаются в футере.
...
| **Включить Gemini** | Включает Gemini 2.0 Flash. Переключатели по функциям позволяют отдельно выбрать голосовые субтитры и отправляемые сообщения |
...
├── content-whisper.js      # Content script (распознавание Whisper и субтитры)
